...
// import { ExclamationCircleIcon, CheckCircleIcon } from '@heroicons/react/24/solid'; // For icons
//
...
//
//         try {
//             // *** IMPORTANT: Adjust API endpoint and payload as needed ***
//             // Common endpoint: /api/auth/password/change/ (if using dj-rest-auth)
//             // Or a custom one like /api/user/change-password/
//             const response = await api.post('/backend/api/user/change-password/', { // Replace with your actual endpoint
//                 old_password: currentPassword, // Field names depend on backend
//                 new_password1: newPassword,    // Usually requires new password twice
//                 new_password2: confirmPassword, // for confirmation on backend too
//             });
//
//             console.log("Change password response:", response); // Log success response if any
//
...
//                             className="block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm"
//                         />
//                     </div>
//
//                     {/* New Password */}
