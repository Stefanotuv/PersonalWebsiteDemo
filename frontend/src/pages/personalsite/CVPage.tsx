...
const CVPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCurrentCVDocument = async () => {
      ...
      try {
        ...
        setErrorCV("Failed to load current CV. Please try again later or contact Admin.");
      } finally {
        setLoadingCV(false);
      }
    };
  ...
  return (
    <>
      <Helmet>
        <title>{SITE_OWNER_FULL_NAME}- Curriculum Vitae</title>
        <meta name="description" content="{SITE_OWNER_FULL_NAME}'s professional curriculum vitae and work experience." />
      </Helmet>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-8">
            ...
            {loadingCV ? (
                ...
                <a
                    ...
                    download={currentCV.name || 'name_surname_CV'} // Suggest filename from doc name
