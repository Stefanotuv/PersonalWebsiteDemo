// // frontend/src/components/layout/Navbar.tsx - UPDATED WITH NEW LINKS
//
...
//
// // Import relevant icons for new links
// import { FaHome, FaUserShield, FaFilePdf, FaGlobe, FaInfoCircle } from 'react-icons/fa';
//
// interface AuthUser {
//   id?: number;
//   email?: string;
...
//                   <FaFilePdf className="inline-block mr-2" /> CV
//                 </Link>
//                 <Link to={"/on-the-web"} className={commonLinkClasses}>
//                   <FaGlobe className="inline-block mr-2" /> On the Web
//                 </Link>
...
// frontend/src/components/layout/Navbar.tsx - MODIFIED (NO PROFILE PIC)
//
// import React, { useState, useEffect } from "react";
// import { Link } from "react-router-dom";
// import { useAuth } from '../../../context/AuthContext';
// // Removed: default_avatar import
// // Removed: api import as it's not directly used in Navbar for authentication flow
//
...
//   last_name?: string;
//   is_staff?: boolean;
//   // Removed profile property as it's no longer displayed
// }
//
// function Navbar() {
//   const [isOpen, setIsOpen] = useState(false);
...
//   }, []);
//
//   // --- Removed: Profile Picture URL Calculation Logic ---
//   // No profilePictureUrl variable or related logic needed here anymore.
//
//   if (isLoading) {
//     return (
//       <nav className="fixed top-0 z-50 w-full bg-gray-900 p-4 text-white flex items-center justify-center h-16">
...
//                 )}
//                 {/*{isStaff && (*/}
//                 {/*  <Link to={"/admin/documents"} className={`${commonLinkClasses} text-orange-300 hover:bg-gray-700`}>*/}
//                 {/*    Docs Admin*/}
//                 {/*  </Link>*/}
//                 {/*)}*/}
//                 {/*{isStaff && (*/}
//                 {/*  <Link to={"/admin/photos"} className={`${commonLinkClasses} text-pink-300 hover:bg-gray-700`}>*/}
//                 {/*    Photos Admin*/}
//                 {/*  </Link>*/}
//                 {/*)}*/}
//               </div>
...
//           <div className="flex items-center ml-auto">
//             {isAuthenticated && user ? (
//               // Display email and dropdown for authenticated users (no profile picture)
//               <div className="relative group flex items-center space-x-3"> {/* Added flex and space-x */}
              ...
              <div className="relative group flex items-center space-x-3">
                ...
                <div className="relative">
                    ...
                    <ul className="absolute hidden right-0 text-gray-700 bg-white shadow-lg rounded-md border border-gray-200 w-48 group-hover:block pb-2 z-40">
                        {isStaff && (
                        <li>
                            <a href="https://www.stefanotuveri.com/admin/" target="_blank" rel="noopener noreferrer" className="rounded-t-md block px-4 py-2 text-sm hover:bg-gray-100">
                                <FaUserShield className="inline-block mr-2" /> Django Admin
                            </a>
                        </li>
                        )}
          ...
          <div className="flex flex-col px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="border-t border-gray-700 pt-4 mt-3">
              {!isAuthenticated ? (
                ...
                <>
                  <Link to={"/profile"} onClick={() => setIsOpen(false)} className={commonLinkClasses}>Profile</Link>
                  {isStaff && (<a href="https://www.stefanotuveri.com/admin/" target="_blank" rel="noopener noreferrer" onClick={() => setIsOpen(false)} className={`${commonLinkClasses} text-yellow-300`}>Django Admin</a>)}
                  <button onClick={() => { logout(); setIsOpen(false); }} className="w-full text-left block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-gray-700 cursor-pointer">Sign Out</button>
                </>
              )}
            </div>
